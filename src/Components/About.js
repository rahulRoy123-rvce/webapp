      ...
      <div className="p-12">
        ...
        >
          <div className="max-w mx-auto  rounded-lg  flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 p-4 flex flex-col gap-5 ml-4">
              ...
              <div>
              <button className="text-white text-2xl  bg-[#1A5130] transition-colors duration-300 hover:bg-white hover:text-[#1a5130] hover:border hover:border-[#1a5130] font-medium py-2  rounded-full w-72 h-12">
                Carbon Calculator
              </button>
              </div>
            </div>
      ...
      <div className="p-12">
        ...
        >
          <div className="md:flex-1 md:pr-10 md:w-1/2 flex flex-col gap-8 justify-center items-center p-7">
            ...
            <button className="text-white bg-[#1A5130] transition-colors duration-300 hover:bg-white hover:text-[#1a5130] hover:border hover:border-[#1a5130] font-medium text-3xl pb-2 px-6 rounded-full w-72 h-12 ">
              Projects
            </button>
          </div>
          <div
